...
const KPI_EXPLANATIONS = {
  ...
  "Performance Gross": "Performance oficial do processo completo, considerando a regra Gross do cliente e Owner.", "Gross recalculado": "Performance calculada pela regra operacional vigente, usando etapas, cortes e dias úteis configurados.", "Performance Gross dos concluídos": "Performance Gross considerando somente processos que chegaram ao evento final.", "Gross de concluídos": "Performance Gross considerando somente processos que chegaram ao evento final.", "Performance NET": "Performance depois da aplicação da capacidade diária. Linhas acima da capacidade permanecem no Gross.", "SLA NET": "Performance depois da aplicação da capacidade diária. Linhas acima da capacidade permanecem no Gross.", "Diferença NET x Gross": "Variação causada pela capacidade diária entre o resultado Gross e o resultado NET.", "Atrasados em aberto": "Processos ainda abertos cujo prazo já venceu. Pode ficar indisponível quando a fonte contém somente pedidos expedidos.", "Capacidade oficial": "Limite diário oficial de linhas usado para determinar quais linhas entram no NET.", "Capacidade de referência": "Capacidade sugerida ou histórica enquanto a capacidade oficial ainda não está ativa.",
...
function performanceMetricGuide(operation) {
  ...
  return `<details class="metric-guide"><summary>Como interpretar Gross, NET, capacidade e cobertura</summary><dl><div><dt>Performance Gross</dt><dd>Resultado considerando os ${process} elegíveis pela regra de prazo do cliente.</dd></div><div><dt>Performance NET</dt><dd>Resultado depois de retirar as linhas acima da capacidade diária oficial ativa. Sem capacidade oficial, o NET fica como “—”.</dd></div><div><dt>Capacidade</dt><dd>Limite de linhas por dia usado para definir quais linhas entram no NET.</dd></div><div><dt>Cobertura</dt><dd>Percentual de registros com dados suficientes para o cálculo. Registros sem informação não entram no denominador.</dd></div></dl></details>`;
}
